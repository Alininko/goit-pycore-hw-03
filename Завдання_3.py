...
def normalize_phone(phone_number) -> str: 
    """Formatting a list of given phone numbers in different formats, with or without Ukraine country code, 
    to the following example +380952345678, by adding country code, removing all elements instead of numbers and +"""
